...
public class AntSimGUI extends JFrame
{
	 ...
	 *
	 *	@param	time		String indicating simulation time in terms of turns
	 */
	 ...
	 *	set the current simulation time
	 *
	 *	@param	days		String indicating simulation time in terms of days
	 */
	public void setDays(String days)
	{
		controlPanel.setDays(days);
	}

	/**
	 *	set the current simulation time
	 *
	 *	@param	years		String indicating simulation time in terms of days
	 */
	public void setYears(String years)
	{
		controlPanel.setYears(years);
	}
	...
	private class ControlPanel extends JPanel
	{
		...
		// label for displaying the days in the simulation
		...
		private void initComponents()
		{
			...
			// label for displaying simulation days
			dayLabel = new JLabel();
			dayLabel.setFont(new Font("Verdana", Font.BOLD, 16));

			// label for displaying simulation days
			yearLabel = new JLabel();
			yearLabel.setFont(new Font("Verdana", Font.BOLD, 16));
		...
		/**
		 *	set the current simulation days
		 *
		 *	@param	days		String indicating simulation time in terms of days
		 */
		public void setDays(String days)
		...
		/**
		 *	set the current simulation years
		 *
		 *	@param	years		String indicating simulation time in terms of days
		 */
		public void setYears(String years)
